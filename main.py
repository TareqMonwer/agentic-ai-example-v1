...
def linkedin_profile_facts(profile_name_query: str, mock: bool):
    ...
    summary_prompt_template = PromptTemplate(
        ...
        partial_variables={"format_instructions": profile_summary_parser.get_format_instructions()}
    )
    ...
    chain = summary_prompt_template | llm | profile_summary_parser
...
if __name__ == "__main__":
    response = linkedin_profile_facts("Akshay Saini Linkedin Profile", True)
    # print(response)
